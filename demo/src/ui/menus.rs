    ...
    egui::Area::new("main_menu_bg")
        ...
        .show(ctx, |ui| {
            ...
            ui.painter().rect_filled(
                screen_rect,
                0.0,
                egui::Color32::from_rgba_premultiplied(10, 10, 12, 230),
            );
        });
    ...
    egui::Area::new("main_menu_content")
        ...
        .show(ctx, |ui| {
            ui.vertical_centered(|ui| {
                ui.label(
                    egui::RichText::new("GIZMO ENGINE")
                        .size(72.0)
                        .strong()
                ...
                ui.add_space(8.0);
                ui.label(
                    egui::RichText::new("NoroNest Pre-Alpha")
                        .size(24.0)
                ...
                if ui
                    .add_sized(
                        btn_size,
                        egui::Button::new(egui::RichText::new("Oyuna Başla").size(22.0)),
                    )
                    .clicked()
                {
                ...
                if ui
                    .add_sized(
                        btn_size,
                        egui::Button::new(egui::RichText::new("Ayarlar").size(22.0)),
                    )
                    .clicked()
                {
                    // TODO: Settings
                ...
                if ui
                    .add_sized(
                        btn_size,
                        egui::Button::new(egui::RichText::new("Çıkış").size(22.0)),
                    )
                    .clicked()
                {
                    std::process::exit(0);
        ...
        .show(ctx, |ui| {
            ui.vertical_centered(|ui| {
                ...
                if ui
                    .add_sized(
                        btn_size,
                        egui::Button::new(egui::RichText::new("Devam Et (Resume)").size(22.0)),
                    )
                    .clicked()
                {
                    if let Some(mut m) = world.get_resource_mut::<crate::state::AppMode>() {
                ...
                if ui
                    .add_sized(
                        btn_size,
                        egui::Button::new(egui::RichText::new("Ana Menü (Main Menu)").size(22.0)),
                    )
                    .clicked()
                {
                    if let Some(mut m) = world.get_resource_mut::<crate::state::AppMode>() {
