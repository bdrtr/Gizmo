...
pub fn run_scripts(world: &mut World, _state: &mut GameState, dt: f32, input: &Input) -> Vec<gizmo::scripting::commands::ScriptCommand> {
...
pub fn process_game_commands(world: &mut World, state: &mut GameState, dt: f32, commands: Vec<gizmo::scripting::commands::ScriptCommand>) {
