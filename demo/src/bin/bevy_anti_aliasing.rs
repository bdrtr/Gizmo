//! # Bevy'nin `3d/anti_aliasing` örneğinin Gizmo Engine portu
//!
...
//!
//! ## Envanter: Bevy'nin beşinden ikisi var
//!
//! | Bevy | Gizmo |
//! |------|-------|
...
//!
//! "Daha yumuşak görünüyor" bir ölçüm değil. Bu port kenarı **komşu piksel farkıyla** ölçüyor:
...
fn main() {
    App::<SimpleSceneState>::new("Gizmo Engine - Bevy Anti-Aliasing", 1280, 720)
            ...
            gizmo::egui::Area::new("aa".into())
                ...
                .show(ctx, |ui| {
                    gizmo::egui::Frame::popup(ui.style()).show(ui, |ui| {
                        ...
                        ui.label("FXAA açık/kapalı; Bevy'deki duyarlılık kademeleri yok");
                        ui.separator();
