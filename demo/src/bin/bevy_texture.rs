//! # Bevy'nin `3d/texture` örneğinin Gizmo Engine portu
//!
...
//! [`AssetManager::load_material_texture`]'ı ile. Bevy'nin örneği kendi logosunu yüklüyor; bu
//! depo hiçbir marka varlığı taşımadığı için mevcut dokulardan biri kullanıldı. Yükleme yolu
//! çalışma dizinine göre çözülüyor — demo depo kökünden çalıştırılmalı (`cargo run` zaten öyle
//! yapar).
//!
//! ## Kontroller
...
/// Dörtgenin genişliği ve en-boy oranı (Bevy'de 8,0 ve 0,25).
...
fn main() {
    App::<SimpleSceneState>::new("Gizmo Engine - Bevy Texture", 1280, 720)
        .with_simple_scene(|scene, state| {
            ...
            // Bevy'nin dörtgenleri X ekseninde −36° yatık duruyor.
            ...
            for (z, albedo) in [
                ...
                scene.world.spawn_bundle((
                    ...
                    // malzemeyi saydam kovaya alır; Bevy'nin `unlit: true` + `AlphaMode::Blend`
                    // ikilisinin karşılığı tek çağrıda.
