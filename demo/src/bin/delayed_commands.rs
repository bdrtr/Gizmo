//! # Gecikmeli komutlar
//!
//! **Bir süre sonra etkisini gösterecek komut** göndermek.
//!
//! ## Motorda genel bir gecikmeli komut yok, bir özel hâli var
//!
//! | yetenek | Gizmo |
//! |---------|-------|
//! | komutu bir göreve ya da zamanlayıcı + gözlemci çiftine bağlayıp ertelemek | genel bir gecikme mekanizması **yok** |
//! | herhangi bir komutu geciktirmek | **yok** |
//! | *silmeyi* geciktirmek | var — [`DespawnAfter`] |
//! | tekrarlayabilen bir zamanlayıcı türü | **yok** — `Time` var, sayacı siz tutuyorsunuz |
//!
...
/// Geciktirilebilen işler. Burada bir enum, çünkü bileşen `Clone` olmak zorunda ve
/// `Box<dyn FnOnce>` değil.
...
fn main() {
    App::<SimpleSceneState>::new("Gizmo Engine - Delayed Commands", 1280, 720)
