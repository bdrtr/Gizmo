//! # Bevy'nin `3d/visibility_range` örneğinin Gizmo Engine portu
//!
//! Uzaklığa göre ayrıntı düzeyi: nesne uzaklaştıkça daha kaba bir mesh'e geçmek. Bevy'de bu
//! `VisibilityRange` bileşeni — her LOD kademesi için başlangıç/bitiş mesafeleri ve aralarında
//! çapraz geçiş (kademeler bir bantta birlikte, alfa ile karışarak çizilir).
//!
//! ## Motorda LOD var, ama tek kademe ve tek eşik
//!
//! | Bevy | Gizmo |
//! |------|-------|
//! | kademe sayısı serbest | **bir tane**: `lod_vbufs[0]` |
//! | her kademeye ayrı mesafe | **tek kural**: `mesafe > yarıçap × 15` |
//! | çapraz geçiş (crossfade) | **yok** — anlık takas |
//! | `use_aabb` seçeneği | **yok** |
...
fn main() {
    ...
    App::<SimpleSceneState>::new("Gizmo Engine - Bevy Visibility Range", 1280, 720)
            ...
            gizmo::egui::Area::new("lod".into())
                ...
                .show(ctx, |ui| {
                    gizmo::egui::Frame::popup(ui.style()).show(ui, |ui| {
                        ...
                        ui.label("Bevy'de kademe sayısı ve her kademenin mesafesi serbest,");
                        ui.label("ve kademeler bir bantta alfa ile karışarak geçiyor.");
                    });
                });
        })
        .run()
