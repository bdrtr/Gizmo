...
//!
//! **Dönüşü elle yazmak gerekmiyor**: [`Spin`] + [`SpinPlugin`] işi bileşen olarak veriyor —
//! burada X ekseni, 3,0 rad/s.
//!
//! Sahnenin sayıları:
//!   * Küpler 2×2×2 — Gizmo'nun hazır küp mesh'i zaten 2 birim, ölçek yok.
...
/// Dönüş hızı: X ekseninde 3,0 rad/s.
...
fn main() {
    App::<SimpleSceneState>::new("Gizmo Engine - Parenting", 1280, 720)
        .with_simple_scene(|scene, state| {
            // İki küp aynı mesh'i ve aynı malzemeyi paylaşır — tek tutamaç klonlanıyor.
