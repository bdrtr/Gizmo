//! # İmleç ışınının zeminle kesişimi
//!
...
//!
//! Yüksek seviye `SimpleAppExt` API + ECS sistemi (`add_system`) ile yazıldı.
...
//! ASIL amacı görüntü alanı koordinatından dünya ışını üretmenin kendisidir).
...
fn main() {
    ...
    app = app
        .with_simple_scene(|scene, state| {
            ...
            // Kamera: (0, 10, 15)'ten Vec3::ZERO'ya bakar
