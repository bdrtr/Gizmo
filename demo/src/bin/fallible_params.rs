//! # Çözülemeyen sistem parametresi
//!
//! Bir sistem, istediği şey henüz **ortada yokken** ne yapmalı? Bir cevap sessiz atlamak:
//! parametre çözülemezse sistem o kare hiç koşmaz ve uygulama sürer.
//!
...
//! fark etmez. Ama sessiz atlamayı isteyen bir oyun için karşılığı ne?
//!
...
//! (kendi partisinde yalnız koşuyor). Parametrenin kendisinin yumuşak bir varyantı olsaydı böyle
//! bir bedel olmazdı.
//!
//! ## Ölçülen
//!
...
fn main() {
    ...
    let mut app = App::<SimpleSceneState>::new("Gizmo Engine - Fallible Params", 1280, 720)
        ...
        gizmo::egui::Area::new("fallible".into())
            ...
            .show(ctx, |ui| {
                gizmo::egui::Frame::popup(ui.style()).show(ui, |ui| {
                    ...
                    ui.separator();
                    ui.label("motor eksik parametrede PANİKLER — sistemi atlamaz.");
