...
//! Klasik çare ışıkta iki ayrı sapma düğmesidir — derinlik sapması ve normal sapması — ve
//! ikisi arasında bir ödünleşme vardır.
//!
...
//!
//! | | değer | çalışma anında ayarlanabilir mi |
//! |---|-------|------|
//! | cascade sayısı | 4 | **hayır** |
//! | gölge haritası çözünürlüğü | 3072² | **hayır** |
//! | gölge menzili | 100 m | **hayır** |
//! | bölme λ (log↔düzgün) | 0,75 | **hayır** |
//! | derinlik/normal sapması | **yok** — türetiliyor | **hayır** — düğme yok |
//!
...
//!
//! Kural şu: "sapmayı kısınca akne çıkar". Burada sapma kısılamadığına göre asıl
...
fn main() {
    App::<SimpleSceneState>::new("Gizmo Engine - Shadow Biases", 1280, 720)
            ...
            gizmo::egui::Area::new("bias".into())
                ...
                .show(ctx, |ui| {
                    gizmo::egui::Frame::popup(ui.style()).show(ui, |ui| {
                        ...
                        ui.label("hepsi csm.rs'te SABİT — çalışma anında ayarlanamıyor");
                        ui.separator();
