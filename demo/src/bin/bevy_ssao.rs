//! # Bevy'nin `3d/ssao` örneğinin Gizmo Engine portu
//!
...
//!
//! ## Envanter: bir düğme, beş kademe değil
//!
//! | | Bevy | Gizmo |
//! |---|------|-------|
//! | kalite | `SsaoQualityLevel`: Low / Medium / High / Ultra / Custom (dilim ve dilim başına örnek sayısıyla) | **yok** |
//! | zamansal gürültü giderme | `TemporalJitter` ile birlikte | **yok** |
...
//! alacağı, hangi yarıçapta arayacağı ve gürültüsünün nasıl gideceği seçilemiyor. Bevy'nin
//! örneğinin bütün kalite karşılaştırması burada tek bir kaydırağa iniyor.
//!
...
fn main() {
    App::<SimpleSceneState>::new("Gizmo Engine - Bevy SSAO", 1280, 720)
            ...
            gizmo::egui::Area::new("ssao".into())
                ...
                .show(ctx, |ui| {
                    gizmo::egui::Frame::popup(ui.style()).show(ui, |ui| {
                        ...
                        ui.label("Bevy'nin kalite kademeleri (Low..Ultra) yok");
