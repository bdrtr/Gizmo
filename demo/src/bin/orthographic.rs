...
//!
//! Bu, deponun ortografik projeksiyonu gösteren İLK demosu. Motorun ifadesi
//! [`ProjectionMode::Orthographic`] `{ height: 6.0 }` — "görüş hacminin DİKEY uzanımı 6 dünya
//! birimi, yatay olan en-boy oranından türetilir" demek.
//!
...
/// Görüş hacminin dikey uzanımı, dünya birimi.
const VIEWPORT_HEIGHT: f32 = 6.0;

fn main() {
    App::<SimpleSceneState>::new("Gizmo Engine - Orthographic", 1280, 720)
