...
//!
//! ## Bu demonun bulduğu şey: `Renderer::exposure` ölü bir alan
//!
...
//!
//! Ve tek yazanı da bu depodaydı: `anisotropy`'nin "Exposure" kaydırağı o ölü alana
//! bağlıydı, yani hiçbir şey yapmıyordu. Bu demo onu da düzeltti — kaydırak artık demonun kendi
...
fn main() {
    App::<SimpleSceneState>::new("Gizmo Engine - Tonemapping", 1280, 720)
            ...
            gizmo::egui::Area::new("tone".into())
                ...
                .show(ctx, |ui| {
                    gizmo::egui::Frame::popup(ui.style()).show(ui, |ui| {
                        ...
                        ui.label("eğri seçimi ve deband dither: motorda YOK");
...
///
/// Pozlamanın adresi `Camera::exposure` — `Renderer::exposure` DEĞİL. Bu demonun bulduğu şey de
