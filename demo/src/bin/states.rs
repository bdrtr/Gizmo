...
//! ve oyun sistemleri yalnız o durumdayken çalışıyor.
//!
//! ## Motorda bunun ne kadarı hazır, ne kadarı sizin
//!
//! Gizmo'da [`State<S>`] ve [`in_state`] var, ve ikisi de beklenen işi yapıyor:
...
//!   2. Duruma **giriş/çıkış çizelgeleri yok**; giriş/çıkış işini elle yapmak gerekiyor.
...
//!
//! Menü, motorun kendi arayüz yolundan geliyor: **egui** (`set_ui`).
//!
//!
//! **Bir motor tuzağı, ve dışarıdan bakınca görünmez:** `add_system` sistemi **sabit
...
fn main() {
    App::<SimpleSceneState>::new("Gizmo Engine - States", 1280, 720)
...
/// Geçişleri uygulayan faz — motorda olmayan tek parça.
///
/// Dönüş değeri "bu karede gerçekten geçiş oldu mu"yu söyler, ve giriş/çıkış çizelgelerinin yerini
...
/// `InGame`'e giriş: oyuncunun küpünü kur.
...
/// `InGame`'den çıkış: oyun sahnesini topla.
