//! # Köşe renkleri
//!
//! Rengi malzemeden değil **mesh'in kendi köşelerinden** almak.
//!
...
//!
//! Bu, bir önceki demonun (`deferred_rendering`) açık bıraktığı halkayı kapatıyor: orada
...
//!
//! **67 kat fark**, ve bu bir önceki demonun açık bıraktığı halkayı kapatıyor:
//! `deferred_rendering`'de `BakedLit` ile `Unlit` aynı pikselleri üretmişti, gerekçe olarak
...
fn main() {
    App::<SimpleSceneState>::new("Gizmo Engine - Vertex Colors", 1280, 720)
