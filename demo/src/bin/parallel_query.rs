...
//! için kilit yok.
//!
//! Alışılmış uyarı şu: 128 eleman üzerinde toplama gibi ucuz bir işlem için paralel
//! yineleyici normalinden hızlı olmayacaktır. Bu demo o cümleyi **ölçüyor**: aynı iş yükü,
//! **P** tuşuyla seri ↔ paralel, ve iki geçişin süresi HUD'da yan yana. Küp sayısı da **+/−**
//! ile değişiyor, çünkü cevabın kendisi sayıya bağlı.
//!
...
//!
//! Yani uyarı doğru, ve **ölçüsü de bu**: 128 elemanda paralel yineleme seri olandan
...
//!
//! Sahne 2B değil: motorda sprite hattı yok (bilinen boşluk), o yüzden ekranda sekip duran
//! sprite'ların yerini bir kutunun içinde sekip duran küpler alıyor.
//!
...
/// Başlangıçtaki küp sayısı — 128 az geliyor, ölçüm ancak burada anlam kazanıyor.
...
fn main() {
    App::<SimpleSceneState>::new("Gizmo Engine - Parallel Query", 1280, 720)
...
///
/// Hareket ve sekme burada tek fonksiyon: paralel geçişte iki ayrı
