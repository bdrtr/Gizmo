//! # Bevy'nin `3d/split_screen` örneğinin Gizmo Engine portu
//!
//! Aynı kareyi ikiye bölüp iki farklı kameradan göstermek. Bevy'de bu, her kameraya bir
//! `Camera::viewport` (hedef üstünde bir dikdörtgen) ve bir `order` vermekle oluyor; iki kamera
//! aynı kareye, yan yana iki bölgeye çiziyor.
//!
...
fn main() {
    App::<SimpleSceneState>::new("Gizmo Engine - Bevy Split Screen", 1280, 720)
