...
//!
//! Bu depo hiç ses varlığı taşımıyor. Demo bu
...
//! bayt okunmuyor.
//!
//! ## Üç kısıt, üçü de motorun tasarımından
//!
//! **1. Dinleyici ayrı bir varlık değil, KAMERA.** Motorun
...
//!
//! **2. Kulak aralığı ayarlanamıyor.** Aralığı dinleyici kurulurken parametre olarak vermek
//! **mümkün değil**. Motorda bu bir sabit: `Listener::EAR_DISTANCE = 0,2` m — gerçek bir
//! kafa kadar.
//!
...
//!
//! Buna karşılık motorun fazladan bir yeteneği var: **Doppler**. Uzamsal sistem
...
//!
//! ## Bu demo bir hata buldu: kulaklar terstiydi
//!
...
struct AudioDemo {
    ...
    device_ready: bool,
    /// Kaynak hareket ediyor mu (boşluk tuşu).
    moving: bool,
    /// Susturuldu mu (M).
    muted: bool,
    /// Yörünge açısı.
...
/// Sesin motordaki adı.
const TONE: &str = "spatial_audio::tone";
...
fn main() {
    App::<SimpleSceneState>::new("Gizmo Engine - Spatial Audio", 1280, 720)
