//! # Bevy'nin `3d/wireframe` örneğinin Gizmo Engine portu
//!
...
//! | Bevy | Gizmo |
//! |------|-------|
//! | `WireframeConfig::global` | [`WireframeConfig::global`] |
//! | `WireframeConfig::default_color` | **yok** |
//! | `Wireframe` bileşeni (bu nesneyi tel kafes çiz) | **yok** |
//! | `NoWireframe` bileşeni (bunu hariç tut) | **yok** |
//! | `WireframeColor` bileşeni (nesne başına renk) | **yok** |
//!
...
//! bir çizgi neredeyse görünmez oluyor — Bevy'nin `WireframeColor`'ı tam olarak bunun için var.
//!
...
fn main() {
    App::<SimpleSceneState>::new("Gizmo Engine - Bevy Wireframe", 1280, 720)
            ...
            gizmo::egui::Area::new("wire".into())
                ...
                .show(ctx, |ui| {
                    gizmo::egui::Frame::popup(ui.style()).show(ui, |ui| {
                        ...
                        ui.label("Bevy'de ayrıca varsayılan renk, nesne başına Wireframe /");
                        ui.label("NoWireframe / WireframeColor bileşenleri var.");
                        ui.separator();
