...
//!
//! Motorda hazır bir seçim katmanı **yok** — takıp işaretçi olaylarını dinleyeceğiniz bir eklenti
//! bulunmuyor. Ama üçü de hazır olan parçalar var ve birleştirmesi altı satır:
//!
...
//!
//! **Ve bunun bir bedeli var, demo onu saklamıyor:** ışın *mesh*'e değil **collider**'a çarpar.
...
//! mesh için `Collider::trimesh` ya da `convex_hull` gerekir. Üçgenlere karşı ışın atan bir seçim
//! arka ucu motorda yok; yerini fizik dünyası tutuyor.
//!
...
fn main() {
    App::<SimpleSceneState>::new("Gizmo Engine - Mesh Picking", 1280, 720)
