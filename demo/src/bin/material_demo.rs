...
// Altın açı adımı (ardışık küpler arası ton farkı).
const GOLDEN_ANGLE: f32 = 137.507_77;

fn main() {
    App::<SimpleSceneState>::new("Gizmo Engine - Material Animation", 1280, 720)
...
/// Küp renklerini zamanla akıcı biçimde döndüren ECS sistemi (100°/sn).
