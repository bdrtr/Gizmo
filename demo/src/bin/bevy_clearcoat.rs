//! # Bevy'nin `3d/clearcoat` örneğinin Gizmo Engine portu
//!
...
//!
//! ## Bevy'de üç düğme, burada bir
//!
//! | Bevy | Gizmo |
//! |------|-------|
//! | `clearcoat` (0..1) | `Material::clear_coat` |
//! | `clearcoat_perceptual_roughness` | **yok** — katmanın pürüzü sabit |
//! | `clearcoat_texture` / `clearcoat_roughness_texture` | **yok** |
//! | `clearcoat_normal_texture` (portakal kabuğu) | **yok** |
//!
...
//! ayrılıyor, "ne kadar vernik" ayrılmıyor. Bevy'nin `clearcoat_perceptual_roughness`'ı katmanın
//! karakterini değiştiren düğmeydi ve burada yok; kalan tek sayı da bu aralıkta az iş görüyor.
//!
...
fn main() {
    App::<SimpleSceneState>::new("Gizmo Engine - Bevy Clearcoat", 1280, 720)
            ...
            gizmo::egui::Area::new("coat".into())
                ...
                .show(ctx, |ui| {
                    gizmo::egui::Frame::popup(ui.style()).show(ui, |ui| {
                        ...
                        ui.separator();
                        ui.label("Bevy'de ayrıca vernik pürüzü ve üç doku var; burada yok");
                    });
                });
        })
        .run()
