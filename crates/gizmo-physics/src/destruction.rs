...
mod tests {
    ...
    fn setup_world() -> PhysicsWorld {
        ...
        use crate::components::{Transform, Velocity, Collider};
        
        world.add_body(e1, rb1, Transform::default(), Velocity::default(), Collider::sphere(1.0));
        world.add_body(e2, rb2, Transform::default(), Velocity::default(), Collider::sphere(1.0));
    ...
    fn test_destruction_fallback_threshold() {
        ...
        use crate::components::{Transform, Velocity, Collider};
        world.add_body(e3, rb3, Transform::default(), Velocity::default(), Collider::sphere(1.0));
