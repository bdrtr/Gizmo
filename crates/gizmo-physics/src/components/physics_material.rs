...
impl Default for CombineMode {
    fn default() -> Self { CombineMode::GeometricMean }
}
...
fn resolve_combine_mode(m1: CombineMode, m2: CombineMode) -> CombineMode {
    match (m1, m2) {
        ...
        (CombineMode::GeometricMean, _) | (_, CombineMode::GeometricMean) => CombineMode::GeometricMean,
...
mod tests {
    ...
    fn test_rubber_ice_low_friction() {
        ...
        assert!(c.dynamic_friction > 0.5, "Rubber's Max mode dominates Ice's Min mode");
    }
