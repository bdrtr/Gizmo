...
fn test_broadphase_performance_10000_objects() {
    ...
    assert!(avg_time_per_frame.as_millis() < 80, "Fizik motoru çok yavaş! Broadphase O(n^2) engelliyor olabilir.");
}
...
fn test_broadphase_performance_100000_objects() {
    ...
    assert!(avg_time_per_frame.as_millis() < 1000, "100.000 obje performansı çok düşük.");
}
