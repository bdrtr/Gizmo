...
impl GpuParticleSystem {
    pub fn new(
        ...
        for i in 0..max_particles {
            let x = (i as f32 % 100.0) * 0.5 - 25.0; // wider spread X
            let y = 15.0 + (i as f32 / 100.0) * 0.05; // high up in the air
            let z = ((i as f32 * 3.7) % 100.0) * 0.5 - 25.0; // wider spread Z
            initial_particles.push(GpuParticle {
                position: [x, y, z],
                life: 0.0,
                velocity: [0.0, 0.0, 0.0],
                max_life: 15.0 + (i as f32 % 5.0),
                color: [1.0, 0.5, 0.1, 0.8], // bright fire / spark color
                size_start: 0.2, size_end: 0.0, _padding: [0.0; 2]
            });
        }
