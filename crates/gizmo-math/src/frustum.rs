...
impl Frustum {
    ...
    pub fn from_matrix(vp: &Mat4) -> Self {
        ...
        let m11 = vp.x_axis.x; let m12 = vp.y_axis.x; let m13 = vp.z_axis.x; let m14 = vp.w_axis.x;
        let m21 = vp.x_axis.y; let m22 = vp.y_axis.y; let m23 = vp.z_axis.y; let m24 = vp.w_axis.y;
        let m31 = vp.x_axis.z; let m32 = vp.y_axis.z; let m33 = vp.z_axis.z; let m34 = vp.w_axis.z;
        let m41 = vp.x_axis.w; let m42 = vp.y_axis.w; let m43 = vp.z_axis.w; let m44 = vp.w_axis.w;
